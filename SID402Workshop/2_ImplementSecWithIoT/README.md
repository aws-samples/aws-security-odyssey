...
- __4.1.5.__ Navigate to **Secure**, **Certificates** and click on the name of your certificate.  On the left menu, click **Policies**. Now select **Attach policy** under Actions and select **device1_allow_publish**. Then detach the **device1_full_access** policy from the certificate.
