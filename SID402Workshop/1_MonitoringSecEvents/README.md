...
<p><h4><b><span style="color:red">IMPORTANT NOTE: Choose one of the following AWS Regions before moving to Step 2: Ireland (eu-west-1), London (eu-west-2), Singapore (ap-southeast-1), Sydney (ap-southeast-2), Tokyo (ap-northeast-1), Seoul (ap-northeast-2).</em></span></b></h4></p>
